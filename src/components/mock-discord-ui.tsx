        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              ...
              />
              <span className="font-medium">Monitrol</span>
            </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f]  flex items-center px-4 shadow-md border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <Image src="/brand-asset-profile-picture.png" alt="MoniTrol Avatar" width={40} height={40} className="object-cover rounded-full mr-3" />
 <div className="absolute bottom-0 right-3 size-3 bg-green-500 rounded-full border-2 border-[#36393f]"></div>
            </div>
            <p className="font-semibold text-white"> MoniTrol</p>
